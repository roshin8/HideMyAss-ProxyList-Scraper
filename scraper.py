...
for tr in proxy_table.tbody.find_all('tr'):
	...
	scraperwiki.sqlite.save(unique_keys=["IP_Address"], data={"IP_address": ip_address, "Anon": anon, "Type": connection_type, "Port": port, "Country": country,  "Last_Update": last_update})
