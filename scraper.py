...
for tr in proxy_table.tbody.find_all('tr'):
	...
	scraperwiki.sqlite.save(unique_keys=["IP_Address"], data={"Anon": anon, "Type": connection_type, "Port": port, "Country": country, "IP_address": ip_address,   "Last_Update": last_update})
